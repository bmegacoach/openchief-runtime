...
/// GET /logo.png — Serve the OpenChief logo.
...
/// GET /favicon.ico — Serve the OpenChief favicon.
...
/// GET / — Serve the OpenChief Dashboard single-page application.
///
...
/// The embedded HTML/CSS/JS for the OpenChief Dashboard.
///
